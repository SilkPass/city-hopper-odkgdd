...
const translations = {
  ...
  uz: {
    ...
    exploreAttractions: 'Diqqatga sazovor joylarni o\'rganing',
    ...
    victoriasPeak: 'Viktoriya cho\'qqisi',
    templeSt: 'Ibodatxona ko\'chasi',
    ...
    payment: 'To\'lov',
    securePayment: 'Xavfsiz to\'lov variantlari',
    guide: 'Qo\'llanma',
    exploreLocal: 'Mahalliy diqqatga sazovor joylarni o\'rganing',
    emergency: 'Favqulodda holat',
    quickEmergency: 'Favqulodda xizmatlarga tez kirish',
    mapsNotSupported: 'Xaritalar Natively veb ko\'rinishida qo\'llab-quvvatlanmaydi',
    ...
    supportServices: 'Qo\'llab-quvvatlash xizmatlari',
    currencyExchange: 'Valyuta almashinuvi',
    convertCurrency: 'Valyutani oson almashtirish',
    healthServices: 'Sog\'liqni saqlash xizmatlari',
