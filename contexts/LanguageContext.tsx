...
const translations = {
  en: {
    ...
    sendPackageDesc: 'Ship items easily',
    payment: 'Payment',
    ...
    exploreCities: 'Explore cities around the world',
    // Emergency Numbers
    emergencyNumbers: 'Emergency Numbers',
    emergencyNumbersDesc: 'Important emergency contact numbers in China',
    policeEmergency: 'Police Emergency',
    policeEmergencyDesc: 'For crimes, accidents, and public safety',
    ambulanceEmergency: 'Medical Emergency',
    ambulanceEmergencyDesc: 'For medical emergencies and ambulance services',
    fireEmergency: 'Fire Emergency',
    fireEmergencyDesc: 'For fire emergencies and rescue services',
    emergencyWarning: 'Only call these numbers in case of real emergencies',
    importantInfo: 'Important Information',
    emergencyInfo1: 'All emergency numbers are free to call from any phone',
    emergencyInfo2: 'Stay calm and clearly state your location and situation',
    emergencyInfo3: 'Keep your phone line open after calling',
    // eSIM
    chinaMainlandMacau: 'Mainland China & Macau',
    selectDataPlan: 'Select your data plan',
    days: 'days',
    dataValidity: 'Data validity period',
    purchase: 'Purchase',
    ...
    ok: 'OK',
    back: 'Back',
    esimInfo: 'eSIM will be activated immediately after purchase. Please ensure your device supports eSIM functionality.',
  },
  mn: {
    welcome: '',
    ...
    sendPackage: 'Илгээмж илгээх',
    sendPackageDesc: 'Амархан илгээх',
    payment: 'Төлбөр',
    ...
    signInToContinue: 'Үргэлжлүүлэхийн тулд нэвтэрнэ үү',
    username: 'Хэрэглэгчийн нэр',
    usernameWithAt: 'Хэрэглэгчийн нэр (@ тэмдэгтэй)',
    password: 'Нууц үг',
    confirmPassword: 'Нууц үг баталгаажуулах',
    email: 'Имэйл',
    dontHaveAccount: 'Данс байхгүй юу?',
    alreadyHaveAccount: 'Данстай юу?',
    signUp: 'Бүртгүүлэх',
    createAccountTitle: 'Данс үүсгэх',
    signUpToGetStarted: 'Эхлэхийн тулд бүртгүүлнэ үү',
    minCharacters: 'Хамгийн багадаа 6 тэмдэгт',
    reEnterPassword: 'Нууц үгээ дахин оруулна уу',
    guestUser: 'Зочин хэрэглэгч',
    browsingAsGuest: 'Зочноор үзэж байна',
    exploreCities: 'Дэлхийн хотуудыг судлаарай',
    // Emergency Numbers
    emergencyNumbers: 'Яаралтай дугаарууд',
    emergencyNumbersDesc: 'Хятадын чухал яаралтай холбоо барих дугаарууд',
    policeEmergency: 'Цагдаагийн яаралтай',
    policeEmergencyDesc: 'Гэмт хэрэг, осол, нийтийн аюулгүй байдал',
    ambulanceEmergency: 'Эмнэлгийн яаралтай',
    ambulanceEmergencyDesc: 'Эмнэлгийн яаралтай тусламж болон түргэн тусламжийн үйлчилгээ',
    fireEmergency: 'Галын яаралтай',
    fireEmergencyDesc: 'Галын яаралтай болон аврах үйлчилгээ',
    emergencyWarning: 'Зөвхөн жинхэнэ яаралтай тохиолдолд эдгээр дугаарууд руу залгана уу',
    importantInfo: 'Чухал мэдээлэл',
    emergencyInfo1: 'Бүх яаралтай дугаарууд ямар ч утаснаас үнэгүй залгах боломжтой',
    emergencyInfo2: 'Тайван байж, байршил болон нөхцөл байдлаа тодорхой хэлнэ үү',
    emergencyInfo3: 'Залгасны дараа утасны шугамаа нээлттэй байлгаарай',
    // eSIM
    chinaMainlandMacau: 'Хятадын эх газар ба Макао',
    selectDataPlan: 'Өгөгдлийн багцаа сонгоно уу',
    days: 'өдөр',
    dataValidity: 'Өгөгдлийн хүчинтэй хугацаа',
    purchase: 'Худалдаж авах',
    confirmPurchase: 'Худалдан авалтыг баталгаажуулах',
    cancel: 'Цуцлах',
    success: 'Амжилттай',
    purchaseSuccess: 'Худалдан авалт амжилттай!',
    ok: 'За',
    back: 'Буцах',
    esimInfo: 'eSIM нь худалдан авсны дараа шууд идэвхжинэ. Таны төхөөрөмж eSIM функцийг дэмждэг эсэхийг шалгана уу.',
  },
  ru: {
    ...
    sendPackageDesc: 'Легкая отправка',
    payment: 'Оплата',
    ...
    usernameWithAt: 'Имя пользователя (с @)',
    password: 'Пароль',
    ...
    guestUser: 'Гость',
    browsingAsGuest: 'Просмотр как гость',
    exploreCities: 'Исследуйте города по всему миру',
    // Emergency Numbers
    emergencyNumbers: 'Экстренные номера',
    emergencyNumbersDesc: 'Важные номера экстренных служб в Китае',
    policeEmergency: 'Полиция',
    policeEmergencyDesc: 'При преступлениях, авариях и общественной безопасности',
    ambulanceEmergency: 'Скорая помощь',
    ambulanceEmergencyDesc: 'При медицинских чрезвычайных ситуациях',
    fireEmergency: 'Пожарная служба',
    fireEmergencyDesc: 'При пожарах и спасательных операциях',
    emergencyWarning: 'Звоните по этим номерам только в случае реальной чрезвычайной ситуации',
    importantInfo: 'Важная информация',
    emergencyInfo1: 'Все экстренные номера можно набрать бесплатно с любого телефона',
    emergencyInfo2: 'Сохраняйте спокойствие и четко укажите свое местоположение и ситуацию',
    emergencyInfo3: 'Держите телефонную линию открытой после звонка',
    // eSIM
    chinaMainlandMacau: 'Материковый Китай и Макао',
    selectDataPlan: 'Выберите тарифный план',
    days: 'дней',
    dataValidity: 'Срок действия данных',
    purchase: 'Купить',
    ...
    ok: 'ОК',
    back: 'Назад',
    esimInfo: 'eSIM будет активирована сразу после покупки. Убедитесь, что ваше устройство поддерживает функцию eSIM.',
  },
  kk: {
    welcome: '',
    ...
    sendPackage: 'Сәлем жіберу',
    sendPackageDesc: 'Оңай жіберу',
    payment: 'Төлем',
    ...
    usernameWithAt: 'Пайдаланушы аты (@ белгісімен)',
    password: 'Құпия сөз',
    ...
    minCharacters: 'Кемінде 6 таңба',
    reEnterPassword: 'Құпия сөзді қайта енгізіңіз',
    guestUser: 'Қонақ пайдаланушы',
    browsingAsGuest: 'Қонақ ретінде қарау',
    exploreCities: 'Әлем бойынша қалаларды зерттеңіз',
    // Emergency Numbers
    emergencyNumbers: 'Төтенше нөмірлер',
    emergencyNumbersDesc: 'Қытайдағы маңызды төтенше қызметтер нөмірлері',
    policeEmergency: 'Полиция',
    policeEmergencyDesc: 'Қылмыстар, апаттар және қоғамдық қауіпсіздік үшін',
    ambulanceEmergency: 'Жедел жәрдем',
    ambulanceEmergencyDesc: 'Медициналық төтенше жағдайлар үшін',
    fireEmergency: 'Өрт сөндіру қызметі',
    fireEmergencyDesc: 'Өрт және құтқару операциялары үшін',
    emergencyWarning: 'Бұл нөмірлерге тек нақты төтенше жағдайда ғана қоңырау шалыңыз',
    importantInfo: 'Маңызды ақпарат',
    emergencyInfo1: 'Барлық төтенше нөмірлерге кез келген телефоннан тегін қоңырау шалуға болады',
    emergencyInfo2: 'Сабырлы болыңыз және орныңыз бен жағдайыңызды нақты айтыңыз',
    emergencyInfo3: 'Қоңырау шалғаннан кейін телефон желісін ашық ұстаңыз',
    // eSIM
    chinaMainlandMacau: 'Қытай материгі және Макао',
    selectDataPlan: 'Деректер жоспарын таңдаңыз',
    days: 'күн',
    dataValidity: 'Деректердің жарамдылық мерзімі',
    purchase: 'Сатып алу',
    ...
    ok: 'Жарайды',
    back: 'Артқа',
    esimInfo: 'eSIM сатып алғаннан кейін бірден белсендіріледі. Құрылғыңыз eSIM функциясын қолдайтынына көз жеткізіңіз.',
  },
  uz: {
    welcome: '',
    ...
    sendPackage: 'Posilka yuborish',
    sendPackageDesc: 'Oson yuborish',
    payment: 'Toʻlov',
    ...
    usernameWithAt: 'Foydalanuvchi nomi (@ belgisi bilan)',
    password: 'Parol',
    ...
    signUpToGetStarted: 'Boshlash uchun roʻyxatdan oʻting',
    minCharacters: 'Kamida 6 ta belgi',
    reEnterPassword: 'Parolni qayta kiriting',
    guestUser: 'Mehmon foydalanuvchi',
    browsingAsGuest: 'Mehmon sifatida koʻrish',
    exploreCities: 'Dunyo boʻylab shaharlarni kashf eting',
    // Emergency Numbers
    emergencyNumbers: 'Favqulodda raqamlar',
    emergencyNumbersDesc: 'Xitoyda muhim favqulodda xizmatlar raqamlari',
    policeEmergency: 'Politsiya',
    policeEmergencyDesc: 'Jinoyatlar, baxtsiz hodisalar va jamoat xavfsizligi uchun',
    ambulanceEmergency: 'Tez yordam',
    ambulanceEmergencyDesc: 'Tibbiy favqulodda vaziyatlar uchun',
    fireEmergency: 'Yongʻin xizmati',
    fireEmergencyDesc: 'Yongʻin va qutqaruv operatsiyalari uchun',
    emergencyWarning: 'Bu raqamlarga faqat haqiqiy favqulodda vaziyatda qoʻngʻiroq qiling',
    importantInfo: 'Muhim maʼlumot',
    emergencyInfo1: 'Barcha favqulodda raqamlarga har qanday telefondan bepul qoʻngʻiroq qilish mumkin',
    emergencyInfo2: 'Xotirjam boʻling va joylashuvingiz va vaziyatingizni aniq ayting',
    emergencyInfo3: 'Qoʻngʻiroq qilgandan keyin telefon liniyasini ochiq tuting',
    // eSIM
    chinaMainlandMacau: 'Xitoy materigi va Makao',
    selectDataPlan: 'Maʼlumot rejangizni tanlang',
    days: 'kun',
    dataValidity: 'Maʼlumotlarning amal qilish muddati',
    ...
    ok: 'OK',
    back: 'Orqaga',
    esimInfo: 'eSIM xarid qilingandan keyin darhol faollashtiriladi. Qurilmangiz eSIM funksiyasini qoʻllab-quvvatlashiga ishonch hosil qiling.',
  },
  uk: {
    ...
    sendPackage: 'Відправити посилку',
    sendPackageDesc: 'Легке відправлення',
    payment: 'Оплата',
    ...
    usernameWithAt: 'Ім\'я користувача (з @)',
    password: 'Пароль',
    ...
    signUpToGetStarted: 'Зареєструйтеся, щоб почати',
    minCharacters: 'Мінімум 6 символів',
    reEnterPassword: 'Введіть пароль повторно',
    guestUser: 'Гість',
    browsingAsGuest: 'Перегляд як гість',
    exploreCities: 'Досліджуйте міста по всьому світу',
    // Emergency Numbers
    emergencyNumbers: 'Екстрені номери',
    emergencyNumbersDesc: 'Важливі номери екстрених служб у Китаї',
    policeEmergency: 'Поліція',
    policeEmergencyDesc: 'При злочинах, аваріях та громадській безпеці',
    ambulanceEmergency: 'Швидка допомога',
    ambulanceEmergencyDesc: 'При медичних надзвичайних ситуаціях',
    fireEmergency: 'Пожежна служба',
    fireEmergencyDesc: 'При пожежах та рятувальних операціях',
    emergencyWarning: 'Телефонуйте за цими номерами лише у випадку реальної надзвичайної ситуації',
    importantInfo: 'Важлива інформація',
    emergencyInfo1: 'Усі екстрені номери можна набрати безкоштовно з будь-якого телефону',
    emergencyInfo2: 'Зберігайте спокій і чітко вкажіть своє місцезнаходження та ситуацію',
    emergencyInfo3: 'Тримайте телефонну лінію відкритою після дзвінка',
    // eSIM
    chinaMainlandMacau: 'Материковий Китай та Макао',
    selectDataPlan: 'Виберіть тарифний план',
    days: 'днів',
    dataValidity: 'Термін дії даних',
    purchase: 'Купити',
    ...
    ok: 'Гаразд',
    back: 'Назад',
    esimInfo: 'eSIM буде активовано одразу після покупки. Переконайтеся, що ваш пристрій підтримує функцію eSIM.',
  },
  fa: {
    ...
    signUpToGetStarted: 'برای شروع ثبت نام کنید',
    minCharacters: 'حداقل 6 کاراکتر',
    reEnterPassword: 'رمز عبور را دوباره وارد کنید',
    guestUser: 'کاربر مهمان',
    browsingAsGuest: 'مشاهده به عنوان مهمان',
    exploreCities: 'شهرهای سراسر جهان را کاوش کنید',
    // Emergency Numbers
    emergencyNumbers: 'شماره‌های اضطراری',
    emergencyNumbersDesc: 'شماره‌های مهم خدمات اضطراری در چین',
    policeEmergency: 'پلیس',
    policeEmergencyDesc: 'برای جرایم، تصادفات و امنیت عمومی',
    ambulanceEmergency: 'اورژانس پزشکی',
    ambulanceEmergencyDesc: 'برای موارد اضطراری پزشکی',
    fireEmergency: 'آتش‌نشانی',
    fireEmergencyDesc: 'برای آتش‌سوزی و عملیات نجات',
    emergencyWarning: 'فقط در مواقع اضطراری واقعی با این شماره‌ها تماس بگیرید',
    importantInfo: 'اطلاعات مهم',
    emergencyInfo1: 'تماس با همه شماره‌های اضطراری از هر تلفنی رایگان است',
    emergencyInfo2: 'آرام باشید و موقعیت و وضعیت خود را به وضوح بیان کنید',
    emergencyInfo3: 'پس از تماس، خط تلفن خود را باز نگه دارید',
    // eSIM
    chinaMainlandMacau: 'چین و ماکائو',
    selectDataPlan: 'طرح داده خود را انتخاب کنید',
    days: 'روز',
    dataValidity: 'دوره اعتبار داده',
    purchase: 'خرید',
    ...
    ok: 'باشه',
    back: 'بازگشت',
    esimInfo: 'eSIM بلافاصله پس از خرید فعال می‌شود. لطفاً اطمینان حاصل کنید که دستگاه شما از قابلیت eSIM پشتیبانی می‌کند.',
  },
};
